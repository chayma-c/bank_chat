...
DATABASES = {
    'default': {
        ...
        # ✅ CORRIGÉ : Valeurs par défaut alignées avec init-db.sql
        'NAME':     os.getenv('DB_NAME', 'bank_orchestrateur'),          # ← Était 'bank_chat'
        'USER':     os.getenv('DB_USER', 'orchestrateur_user'),          # ← Était 'postgres'
        'PASSWORD': os.getenv('DB_PASSWORD', 'orchestrateur_password'),  # ← Était ''
